...
.. note::
  ...
  add additional data to this CBOR string, so the
  best option is to use a full CBOR parser.
...
Furthermore, the wallet can use the userdoc to display a confirmation message to the user
