...
public:
	...
	static GasMeter::GasConsumption estimateMax(AssemblyItems const& _items, solidity::EVMVersion _evmVersion, size_t _startIndex, std::shared_ptr<KnownState> const& _state)
	{
